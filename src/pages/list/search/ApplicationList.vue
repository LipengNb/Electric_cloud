<template>
  <div>
    ...
    <a-list
      ...
      style="margin: 0 -8px"
    >
      <a-list-item v-for="n in 12" :key="n" style="padding: 0 8px">
        <a-card>
          ...
          <a-tooltip slot="actions" class="tool" title="下载">
            <a-icon type="download" />
          </a-tooltip>
          <a-tooltip slot="actions" class="tool" title="编辑">
            <a-icon type="edit" />
          </a-tooltip>
          <a-tooltip slot="actions" class="tool" title="分享">
            <a-icon type="share-alt" />
          </a-tooltip>
          <a-dropdown slot="actions" class="tool">
